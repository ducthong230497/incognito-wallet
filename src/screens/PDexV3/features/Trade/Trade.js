...
import {openOrdersSelector, orderLimitDataSelector, rateDataSelector} from '../OrderLimit/OrderLimit.selector';
import {styled} from './Trade.styled';
import withTrade from './Trade.enhance';
import {getBalance} from '@src/redux/actions/token';

import {formConfigs, OPEN_ORDERS_STATE,} from '../OrderLimit/OrderLimit.constant';
        ...
        try {
            ...
            switch (tabId) {
                case TAB_BUY_LIMIT_ID: {
                    ...
                    const tokenIDToSell = BIG_COINS.PRV;
                    const sellAmount = totalOriginalAmount;
                    const tokenIDToBuy = "c01e7dc1d1aba995c19b257412340b057f8ad1482ccb6a9bb0adce61afbf05d4";//"b832e5d3b1f01a4f0623f7fe91d6673461e1f5d37d91fe78c5c2e6183ff39696";
                    extra = {
                        tokenIDToSell,
                        poolPairID,
                ...
                case TAB_SELL_LIMIT_ID: {
                    ...
                    const tokenIDToSell = "c01e7dc1d1aba995c19b257412340b057f8ad1482ccb6a9bb0adce61afbf05d4";//"b832e5d3b1f01a4f0623f7fe91d6673461e1f5d37d91fe78c5c2e6183ff39696";
    ...
    useEffect(() => {
        ...
        interval = setInterval(() => {
            ...
            batch(async () => {
                ...
                const btcBalance = await dispatch(getBalance("c01e7dc1d1aba995c19b257412340b057f8ad1482ccb6a9bb0adce61afbf05d4"))
